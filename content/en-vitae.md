...
This application is used to predict next words based on your input words.
...
This application is used for visualization, DART, and Batch correction & simulation of metabolomics data.
...
- [Prof. Janusz Pawliszyn](https://uwaterloo.ca/pawliszyn-group/)
    ...
    - Recommendation: [Click Here](https://github.com/yufree/yufree.cn/raw/master/static/data/JanuszPawliszynMiao.pdf)
...
- [Prof. Thanh Wang](https://www.oru.se/english/employee/thanh_wang)
    ...
    - Recommendation: [Click Here](https://github.com/yufree/yufree.cn/raw/master/static/data/ThanhWangMiao.pdf)
...
- [Dr. Yihui Xie](http://yihui.org)
    ...
    - Recommendation: [Click Here](https://yihui.org/en/2018/03/miao-yu-postdoc/)
...
-   <s>I am also skilled to get across the great firewall so never worried about it.</s>
