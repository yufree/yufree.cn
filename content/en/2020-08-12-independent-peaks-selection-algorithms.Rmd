...
plotpca(listb$data,lv = as.numeric(as.factor(list$group)),main = paste(sum(listb$stdmassindex2),"base peaks"))
plotpca(listib$data,lv = as.numeric(as.factor(list$group)),main = paste(sum(listib$stdmassindex2),"independent base peaks"))
